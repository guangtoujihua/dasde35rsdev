...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 华为安全 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 华为安全 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("verify_华为安全_password_tip", "验证 华为安全 密码"),
        ...
        ("upgrade_华为安全_server_pro_to_{}_tip", "请升级专业版服务器到{}或更高版本！"),
        ...
        ("View camera", "查看摄像头"),
        ("upgrade_remote_华为安全_client_to_{}_tip", "请在远程端将 华为安全 客户端升级至版本 {} 或更新版本！"),
