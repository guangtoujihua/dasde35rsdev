...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 手机防护 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 手机防护 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("verify_手机防护_password_tip", "验证 手机防护 密码"),
        ...
        ("upgrade_手机防护_server_pro_to_{}_tip", "请升级专业版服务器到{}或更高版本！"),
        ...
        ("View camera", "查看摄像头"),
        ("upgrade_remote_手机防护_client_to_{}_tip", "请在远程端将 手机防护 客户端升级至版本 {} 或更新版本！"),
